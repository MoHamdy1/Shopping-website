...
if(isset($_POST['add_product'])){
   ...
   $p_brand = $_POST['b_name'];
   $p_image = $_FILES['p_image']['name'];
   $p_image_tmp_name = $_FILES['p_image']['tmp_name'];
   $p_image_folder = 'uploaded_img/'.$p_image;

   $insert_query = mysqli_query($conn, "INSERT INTO `product`(Product_Name, Price, product_image) VALUES('$p_name', '$p_price', '$p_image')") or die('query failed');
   $insert_query1 = mysqli_query($conn, "INSERT INTO `brand`(Brand_Name) VALUES('$p_brand')") or die('query failed');
...
if(isset($_POST['update_product'])){
   ...
   $update_query = mysqli_query($conn, "UPDATE `product` SET Product_Name = '$update_p_name', Price = '$update_p_price', product_image = '$update_p_image' WHERE Product_Id = '$update_p_id'");
...
<form action="" method="post" class="add-product-form" enctype="multipart/form-data">
   ...
   <input type="text" name="b_name" placeholder="enter the brand name" class="box" required>
